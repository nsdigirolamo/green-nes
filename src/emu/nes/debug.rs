...
fn get_label(opcode: u8) -> &'static str {
    match opcode {
        ...
        0x09 => "ORA",
        0x0A => "ASL",
        0x0B => todo!("opcode not yet implemented: {opcode:02X}"),
        0x0C => "NOP",
        0x0D => "ORA",
        0x0E => "ASL",
        0x0F => "SLO",
        ...
        0x29 => "AND",
        0x2A => "ROL",
        0x2B => todo!("opcode not yet implemented: {opcode:02X}"),
        0x2C => "BIT",
        0x2D => "AND",
        0x2E => "ROL",
        0x2F => "RLA",
        ...
        0x49 => "EOR",
        0x4A => "LSR",
        0x4B => todo!("opcode not yet implemented: {opcode:02X}"),
        0x4C => "JMP",
        0x4D => "EOR",
        0x4E => "LSR",
        0x4F => "SRE",
        ...
        0x69 => "ADC",
        0x6A => "ROR",
        0x6B => todo!("opcode not yet implemented: {opcode:02X}"),
        0x6C => "JMP",
        0x6D => "ADC",
        0x6E => "ROR",
        0x6F => "RRA",
        ...
        0xC9 => "CMP",
        0xCA => "DEX",
        0xCB => todo!("opcode not yet implemented: {opcode:02X}"),
        0xCC => "CPY",
        0xCD => "CMP",
        0xCE => "DEC",
        0xCF => "DCP",
