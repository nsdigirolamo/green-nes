use crate::emu::{
    ...
    half_cycles::{
        ...
        get_indirect_x_indexed_low_address_byte, get_pc_address, read_data,
        read_high_effective_address_byte, read_low_effective_address_byte,
    },
...
impl Instruction for Read {
    fn get_cycles(&self, operation: HalfCycle) -> Vec<Cycle> {
        match self {
            ...
            Read::IndirectY => panic!("read indirect y not implemented"),
