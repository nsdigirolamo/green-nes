use crate::emu::{
    ...
    instructions::{
        Instruction, read::Read, read_modify_write::ReadModifyWrite, single_byte::SingleByte,
        store::Store,
    },
    operations::{access, arithmetic, bitwise, compare, flags, other, shift, transfer},
    state::Cycle,
};
...
pub fn get_cycles(opcode: u8) -> Vec<Cycle> {
    match opcode {
        ...
        0x11 => Read::IndirectY.get_cycles(bitwise::ora),
        ...
        0x1D => Read::AbsoluteX.get_cycles(bitwise::ora),
        ...
        0x31 => Read::IndirectY.get_cycles(bitwise::and),
        ...
        0x3D => Read::AbsoluteX.get_cycles(bitwise::and),
        ...
        0x41 => Read::IndirectX.get_cycles(bitwise::and),
        ...
        0x51 => Read::IndirectY.get_cycles(bitwise::eor),
        ...
        0x5D => Read::AbsoluteX.get_cycles(bitwise::eor),
        ...
        0x71 => Read::IndirectY.get_cycles(arithmetic::adc),
        ...
        0x7D => Read::AbsoluteX.get_cycles(arithmetic::adc),
        ...
        0xB1 => Read::IndirectY.get_cycles(access::lda),
        ...
        0xBC => Read::AbsoluteX.get_cycles(access::ldy),
        0xBD => Read::AbsoluteX.get_cycles(access::lda),
        ...
        0xD1 => Read::IndirectY.get_cycles(compare::cmp),
        ...
        0xDD => Read::AbsoluteX.get_cycles(compare::cmp),
        ...
        0xF1 => Read::IndirectY.get_cycles(arithmetic::sbc),
        ...
        0xFD => Read::AbsoluteX.get_cycles(arithmetic::sbc),
