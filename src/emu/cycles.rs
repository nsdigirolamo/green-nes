...
pub fn get_cycles(opcode: u8) -> Vec<Cycle> {
    match opcode {
        ...
        0x83 => Store::IndirectX.get_cycles(access::sax),
        ...
        0x87 => Store::ZeroPage.get_cycles(access::sax),
        ...
        0x8F => Store::Absolute.get_cycles(access::sax),
        ...
        0x97 => Store::ZeroPageY.get_cycles(access::sax),
        ...
        0xAF => Read::Absolute.get_cycles(access::lax),
        ...
        0xB3 => Read::IndirectY.get_cycles(access::lax_indirect_y),
        ...
        0xB7 => Read::ZeroPageY.get_cycles(access::lax),
        ...
        0xBF => Read::AbsoluteY.get_cycles(access::lax_absolute_indexed),
