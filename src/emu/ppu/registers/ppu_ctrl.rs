...
impl PpuControl {
    ...
    pub fn get_base_nametable_addr(&self) -> u16 {
        match self.data & PpuControl::BASE_NAMETABLE_ADDRESS_MASK {
            0 => 0x2000,
            1 => 0x2400,
            2 => 0x2800,
            3 => 0x2C00,
    ...
    pub fn get_vram_addr_incr(&self) -> u16 {
        match self.data & PpuControl::VRAM_ADDRESS_INCREMENT_MASK != 0 {
            true => 32,
            false => 1,
        }
    }
    ...
    pub fn get_sprite_pattern_table_addr(&self) -> u16 {
        match self.data & PpuControl::SPRITE_PATTERN_TABLE_ADDRESS_MASK != 0 {
            true => 0x1000,
            false => 0x0000,
        }
    }
    ...
    pub fn get_background_pattern_table_addr(&self) -> u16 {
        match self.data & PpuControl::BACKGROUND_PATTERN_TABLE_ADDRESS_MASK != 0 {
            true => 0x1000,
            false => 0x0000,
        }
    }
