use crate::emu::ppu::{
    frame::PATTERN_COLS_PER_FRAME,
    patterns::{PATTERN_HEIGHT_PIXELS, PATTERN_TABLES_END_ADDR, PATTERN_WIDTH_PIXELS},
};
...
pub const ATTRIBUTE_AREA_HEIGHT_PIXELS: u16 =
    PATTERN_HEIGHT_PIXELS * PATTERN_ROWS_PER_ATTRIBUTE_AREA;
pub const ATTRIBUTE_AREA_WIDTH_PIXELS: u16 = PATTERN_WIDTH_PIXELS * PATTERN_COLS_PER_ATTRIBUTE_AREA;
